...
export function VaultPage() {
  ...
  return (
    <div className="vault-page">
      ...
      <section className="vault-strategy" aria-labelledby="vaultStrategyTitle">
        <div className="vault-strategy__head">
          <div><div className="vault-hero__eyebrow">Strategy preview</div><h2 id="vaultStrategyTitle">How the Vault seeks to generate returns</h2></div>
          <span className="vault-strategy__badge">Variable · not guaranteed</span>
        </div>
        <div className="vault-driver-grid">
          <div className="vault-driver"><span className="vault-driver__index">01</span><div><strong>Liquidation activity</strong><p>Potential returns from eligible liquidation activity across RailFlow markets.</p></div></div>
          <div className="vault-driver"><span className="vault-driver__index">02</span><div><strong>Native money market</strong><p>Potential lending returns from capital supplied within RailFlow’s money market.</p></div></div>
          <div className="vault-driver"><span className="vault-driver__index">03</span><div><strong>Trading fee share</strong><p>A potential share of trading fees generated by the RailFlow protocol.</p></div></div>
        </div>
        <p className="vault-strategy__note">Return accounting and strategy execution will be connected separately. No APR or return estimate is shown until those data sources are live.</p>
      </section>
