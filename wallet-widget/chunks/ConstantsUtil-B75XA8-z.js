...
`);if(t>-1){let n=e.substring(t+1);this.stack=`${this.name}: ${this.message}\n${n}`,i=!0}}i||(Error.captureStackTrace?Error.captureStackTrace(this,e):this.stack||=`${this.name}: ${this.message}`)}};function He(e,t){let n=e instanceof Ve?e:new Ve(e instanceof Error?e.message:String(e),t,e);throw Be.sendError(n,n.category),n}function k(e,t=`INTERNAL_SDK_ERROR`){let n={};return Object.keys(e).forEach(r=>{let i=e[r];if(typeof i==`function`){let e=i;e=i.constructor.name===`AsyncFunction`?async(...e)=>{try{return await i(...e)}catch(e){return He(e,t)}}:(...e)=>{try{return i(...e)}catch(e){return He(e,t)}},n[r]=e}else n[r]=i}),n}var A={PHANTOM:{id:`a797aa35c0fadbfc1a53e7f675162ed5226968b44a19ee3d24385c64d1d3c393`,url:`https://phantom.app`},SOLFLARE:{id:`1ca0bdd4747578705b1939af023d120677c64fe6ca76add81fda36e350605e79`,url:`https://solflare.com`},COINBASE:{id:`fd20dc426fb37566d803205b19bbc1d4096b248ac04548e3cfb6b3a38bd033aa`,url:`https://go.cb-w.com`}},Ue={handleMobileDeeplinkRedirect(e,t){let n=window.location.href,r=encodeURIComponent(n);if(e===A.PHANTOM.id&&!(`phantom`in window)){let e=n.startsWith(`https`)?`https`:`http`,t=n.split(`/`)[2],i=encodeURIComponent(`${e}://${t}`);window.location.href=`${A.PHANTOM.url}/ul/browse/${r}?ref=${i}`}e===A.SOLFLARE.id&&!(`solflare`in window)&&(window.location.href=`${A.SOLFLARE.url}/ul/v1/browse/${r}?ref=${r}`),t===y.CHAIN.SOLANA&&e===A.COINBASE.id&&!(`coinbaseSolana`in window)&&(window.location.href=`${A.COINBASE.url}/dapp?cb_url=${r}`)}},j=m({walletImages:{},networkImages:{},chainImages:{},connectorImages:{},tokenImages:{},currencyImages:{}}),M=k({state:j,subscribeNetworkImages(e){return h(j.networkImages,()=>e(j.networkImages))},subscribeKey(e,t){return v(j,e,t)},subscribe(e){return h(j,()=>e(j))},setWalletImage(e,t){j.walletImages[e]=t},setNetworkImage(e,t){j.networkImages[e]=t},setChainImage(e,t){j.chainImages[e]=t},setConnectorImage(e,t){j.connectorImages={...j.connectorImages,[e]:t}},setTokenImage(e,t){j.tokenImages[e]=t},setCurrencyImage(e,t){j.currencyImages[e]=t}}),We={eip155:`ba0ba0cd-17c6-4806-ad93-f9d174f17900`,solana:`a1b58899-f671-4276-6a5e-56ca5bd59700`,polkadot:``,bip122:`0b4838db-0161-4ffe-022d-532bf03dba00`,cosmos:``},Ge=m({networkImagePromises:{}}),Ke={async fetchWalletImage(e){if(e)return await I._fetchWalletImage(e),this.getWalletImageById(e)},async fetchNetworkImage(e){return e?this.getNetworkImageById(e)||(Ge.networkImagePromises[e]||(Ge.networkImagePromises[e]=I._fetchNetworkImage(e)),await Ge.networkImagePromises[e],this.getNetworkImageById(e)):void 0},getWalletImageById(e){if(e)return M.state.walletImages[e]},getWalletImage(e){if(e?.image_url)return e?.image_url;if(e?.image_id)return M.state.walletImages[e.image_id]},getNetworkImage(e){if(e?.assets?.imageUrl)return e?.assets?.imageUrl;if(e?.assets?.imageId)return M.state.networkImages[e.assets.imageId]},getNetworkImageById(e){if(e)return M.state.networkImages[e]},getConnectorImage(e){if(e?.imageUrl)return e.imageUrl;if(e?.imageId)return M.state.connectorImages[e.imageId]},getChainImage(e){return M.state.networkImages[We[e]]}},qe=m({message:``,variant:`info`,open:!1}),Je=k({state:qe,subscribeKey(e,t){return v(qe,e,t)},open(e,t){let{debug:n}=O.state,{shortMessage:r,longMessage:i}=e;n&&(qe.message=r,qe.variant=t,qe.open=!0),i&&console.error(typeof i==`function`?i():i)},close(){qe.open=!1,qe.message=``,qe.variant=`info`}}),Ye=new Ne({baseUrl:E.getAnalyticsUrl(),clientId:null}),Xe=[`MODAL_CREATED`],Ze=m({timestamp:Date.now(),reportedErrors:{},data:{type:`track`,event:`MODAL_CREATED`}}),N={state:Ze,subscribe(e){return h(Ze,()=>e(Ze))},getSdkProperties(){let{projectId:e,sdkType:t,sdkVersion:n}=O.state;return{projectId:e,st:t,sv:n||`html-wagmi-4.2.2`}},async _sendAnalyticsEvent(e){try{let t=Q.state.address;if(Xe.includes(e.data.event)||typeof window>`u`)return;await Ye.post({path:`/e`,params:N.getSdkProperties(),body:{eventId:E.getUUID(),url:window.location.href,domain:window.location.hostname,timestamp:e.timestamp,props:{...e.data,address:t}}}),Ze.reportedErrors.FORBIDDEN=!1}catch(e){e instanceof Error&&e.cause instanceof Response&&e.cause.status===y.HTTP_STATUS_CODES.FORBIDDEN&&!Ze.reportedErrors.FORBIDDEN&&(Je.open({shortMessage:`Invalid App Configuration`,longMessage:`Origin ${De()?window.origin:`uknown`} not found on Allowlist - update configuration on cloud.reown.com`},`error`),Ze.reportedErrors.FORBIDDEN=!0)}},sendEvent(e){Ze.timestamp=Date.now(),Ze.data=e,O.state.features?.analytics&&N._sendAnalyticsEvent(Ze)}},P=new Ne({baseUrl:E.getApiUrl(),clientId:null}),Qe=40,$e=4,et=20,F=m({promises:{},page:1,count:0,featured:[],allFeatured:[],recommended:[],allRecommended:[],wallets:[],filteredWallets:[],search:[],isAnalyticsEnabled:!1,excludedWallets:[],isFetchingRecommendedWallets:!1}),I={state:F,subscribeKey(e,t){return v(F,e,t)},_getSdkProperties(){let{projectId:e,sdkType:t,sdkVersion:n}=O.state;return{projectId:e,st:t||`appkit`,sv:n||`html-wagmi-4.2.2`}},_filterOutExtensions(e){return O.state.isUniversalProvider?e.filter(e=>!!(e.mobile_link||e.desktop_link||e.webapp_link)):e},async _fetchWalletImage(e){let t=`${P.baseUrl}/getWalletImage/${e}`,n=await P.getBlob({path:t,params:I._getSdkProperties()});M.setWalletImage(e,URL.createObjectURL(n))},async _fetchNetworkImage(e){let t=`${P.baseUrl}/public/getAssetImage/${e}`,n=await P.getBlob({path:t,params:I._getSdkProperties()});M.setNetworkImage(e,URL.createObjectURL(n))},async _fetchConnectorImage(e){let t=`${P.baseUrl}/public/getAssetImage/${e}`,n=await P.getBlob({path:t,params:I._getSdkProperties()});M.setConnectorImage(e,URL.createObjectURL(n))},async _fetchCurrencyImage(e){let t=`${P.baseUrl}/public/getCurrencyImage/${e}`,n=await P.getBlob({path:t,params:I._getSdkProperties()});M.setCurrencyImage(e,URL.createObjectURL(n))},async _fetchTokenImage(e){let t=`${P.baseUrl}/public/getTokenImage/${e}`,n=await P.getBlob({path:t,params:I._getSdkProperties()});M.setTokenImage(e,URL.createObjectURL(n))},_filterWalletsByPlatform(e){return E.isMobile()?e?.filter(e=>e.mobile_link||e.id===A.COINBASE.id?!0:J.state.activeChain===`solana`&&(e.id===A.SOLFLARE.id||e.id===A.PHANTOM.id)):e},async fetchProjectConfig(){return(await P.get({path:`/appkit/v1/config`,params:I._getSdkProperties()})).features},async fetchAllowedOrigins(){try{let{allowedOrigins:e}=await P.get({path:`/projects/v1/origins`,params:I._getSdkProperties()});return e}catch{return[]}},async fetchNetworkImages(){let e=J.getAllRequestedCaipNetworks()?.map(({assets:e})=>e?.imageId).filter(Boolean).filter(e=>!Ke.getNetworkImageById(e));e&&await Promise.allSettled(e.map(e=>I._fetchNetworkImage(e)))},async fetchConnectorImages(){let{connectors:e}=B.state,t=e.map(({imageId:e})=>e).filter(Boolean);await Promise.allSettled(t.map(e=>I._fetchConnectorImage(e)))},async fetchCurrencyImages(e=[]){await Promise.allSettled(e.map(e=>I._fetchCurrencyImage(e)))},async fetchTokenImages(e=[]){await Promise.allSettled(e.map(e=>I._fetchTokenImage(e)))},async fetchWallets(e){let t=e.exclude??[];I._getSdkProperties().sv.startsWith(`html-core-`)&&t.push(...Object.values(A).map(e=>e.id));let n=await P.get({path:`/getWallets`,params:{...I._getSdkProperties(),...e,page:String(e.page),entries:String(e.entries),include:e.include?.join(`,`),exclude:t.join(`,`)}});return{data:I._filterWalletsByPlatform(n?.data)||[],count:n?.count}},async fetchFeaturedWallets(){let{featuredWalletIds:e}=O.state;if(e?.length){let t={...I._getSdkProperties(),page:1,entries:e?.length??$e,include:e},{data:n}=await I.fetchWallets(t),r=[...n].sort((t,n)=>e.indexOf(t.id)-e.indexOf(n.id)),i=r.map(e=>e.image_id).filter(Boolean);await Promise.allSettled(i.map(e=>I._fetchWalletImage(e))),F.featured=r,F.allFeatured=r}},async fetchRecommendedWallets(){try{F.isFetchingRecommendedWallets=!0;let{includeWalletIds:e,excludeWalletIds:t,featuredWalletIds:n}=O.state,r={page:1,entries:$e,include:e,exclude:[...t??[],...n??[]].filter(Boolean),chains:J.getRequestedCaipNetworkIds().join(`,`)},{data:i,count:a}=await I.fetchWallets(r),o=T.getRecentWallets(),s=i.map(e=>e.image_id).filter(Boolean),c=o.map(e=>e.image_id).filter(Boolean);await Promise.allSettled([...s,...c].map(e=>I._fetchWalletImage(e))),F.recommended=i,F.allRecommended=i,F.count=a??0}catch{}finally{F.isFetchingRecommendedWallets=!1}},async fetchWalletsByPage({page:e}){let{includeWalletIds:t,excludeWalletIds:n,featuredWalletIds:r}=O.state,i=J.getRequestedCaipNetworkIds().join(`,`),a={page:e,entries:Qe,include:t,exclude:[...F.recommended.map(({id:e})=>e),...n??[],...r??[]].filter(Boolean),chains:i},{data:o,count:s}=await I.fetchWallets(a),c=o.slice(0,et).map(e=>e.image_id).filter(Boolean);await Promise.allSettled(c.map(e=>I._fetchWalletImage(e))),F.wallets=E.uniqueBy([...F.wallets,...I._filterOutExtensions(o)],`id`).filter(e=>e.chains?.some(e=>i.includes(e))),F.count=s>F.count?s:F.count,F.page=e},async initializeExcludedWallets({ids:e}){let t={page:1,entries:e.length,include:e},{data:n}=await I.fetchWallets(t);n&&n.forEach(e=>{F.excludedWallets.push({rdns:e.rdns,name:e.name})})},async searchWallet({search:e,badge:t}){let{includeWalletIds:n,excludeWalletIds:r}=O.state,i=J.getRequestedCaipNetworkIds().join(`,`);F.search=[];let a={page:1,entries:100,search:e?.trim(),badge_type:t,include:n,exclude:r,chains:i},{data:o}=await I.fetchWallets(a);N.sendEvent({type:`track`,event:`SEARCH_WALLET`,properties:{badge:t??``,search:e??``}});let s=o.map(e=>e.image_id).filter(Boolean);await Promise.allSettled([...s.map(e=>I._fetchWalletImage(e)),E.wait(300)]),F.search=I._filterOutExtensions(o)},initPromise(e,t){return F.promises[e]||(F.promises[e]=t())},prefetch({fetchConnectorImages:e=!0,fetchFeaturedWallets:t=!0,fetchRecommendedWallets:n=!0,fetchNetworkImages:r=!0}={}){let i=[e&&I.initPromise(`connectorImages`,I.fetchConnectorImages),t&&I.initPromise(`featuredWallets`,I.fetchFeaturedWallets),n&&I.initPromise(`recommendedWallets`,I.fetchRecommendedWallets),r&&I.initPromise(`networkImages`,I.fetchNetworkImages)].filter(Boolean);return Promise.allSettled(i)},prefetchAnalyticsConfig(){O.state.features?.analytics&&I.fetchAnalyticsConfig()},async fetchAnalyticsConfig(){try{let{isAnalyticsEnabled:e}=await P.get({path:`/getAnalyticsConfig`,params:I._getSdkProperties()});O.setFeatures({analytics:e})}catch{O.setFeatures({analytics:!1})}},filterByNamespaces(e){if(!e?.length){F.featured=F.allFeatured,F.recommended=F.allRecommended;return}let t=J.getRequestedCaipNetworkIds().join(`,`);F.featured=F.allFeatured.filter(e=>e.chains?.some(e=>t.includes(e))),F.recommended=F.allRecommended.filter(e=>e.chains?.some(e=>t.includes(e))),F.filteredWallets=F.wallets.filter(e=>e.chains?.some(e=>t.includes(e)))},clearFilterByNamespaces(){F.filteredWallets=[]},setFilterByNamespace(e){if(!e){F.featured=F.allFeatured,F.recommended=F.allRecommended;return}let t=J.getRequestedCaipNetworkIds().join(`,`);F.featured=F.allFeatured.filter(e=>e.chains?.some(e=>t.includes(e))),F.recommended=F.allRecommended.filter(e=>e.chains?.some(e=>t.includes(e))),F.filteredWallets=F.wallets.filter(e=>e.chains?.some(e=>t.includes(e)))}},L=m({view:`Connect`,history:[`Connect`],transactionStack:[]}),R=k({state:L,subscribeKey(e,t){return v(L,e,t)},pushTransactionStack(e){L.transactionStack.push(e)},popTransactionStack(e){let t=L.transactionStack.pop();if(!t)return;let{onSuccess:n,onError:r,onCancel:i}=t;switch(e){case`success`:n?.();break;case`error`:r?.(),R.goBack();break;case`cancel`:i?.(),R.goBack()}},push(e,t){e!==L.view&&(L.view=e,L.history.push(e),L.data=t)},reset(e,t){L.view=e,L.history=[e],L.data=t},replace(e,t){L.history.at(-1)!==e&&(L.view=e,L.history[L.history.length-1]=e,L.data=t)},goBack(){let e=J.state.activeCaipAddress,t=R.state.view===`ConnectingFarcaster`,n=!e&&t;if(L.history.length>1){L.history.pop();let[t]=L.history.slice(-1);t&&(L.view=e&&t===`Connect`?`Account`:t)}else yt.close();L.data?.wallet&&(L.data.wallet=void 0),setTimeout(()=>{if(n){Q.setFarcasterUrl(void 0,J.state.activeChain);let e=B.getAuthConnector();e?.provider?.reload();let t=g(O.state);e?.provider?.syncDappData?.({metadata:t.metadata,sdkVersion:t.sdkVersion,projectId:t.projectId,sdkType:t.sdkType})}},100)},goBackToIndex(e){if(L.history.length>1){L.history=L.history.slice(0,e+1);let[t]=L.history.slice(-1);t&&(L.view=t)}},goBackOrCloseModal(){R.state.history.length>1?R.goBack():yt.close()}}),tt=m({themeMode:`dark`,themeVariables:{},w3mThemeVariables:void 0}),nt={state:tt,subscribe(e){return h(tt,()=>e(tt))},setThemeMode(e){tt.themeMode=e;try{let t=B.getAuthConnector();if(t){let n=nt.getSnapshot().themeVariables;t.provider.syncTheme({themeMode:e,themeVariables:n,w3mThemeVariables:Oe(n,e)})}}catch{console.info(`Unable to sync theme to auth connector`)}},setThemeVariables(e){tt.themeVariables={...tt.themeVariables,...e};try{let e=B.getAuthConnector();if(e){let t=nt.getSnapshot().themeVariables;e.provider.syncTheme({themeVariables:t,w3mThemeVariables:Oe(tt.themeVariables,tt.themeMode)})}}catch{console.info(`Unable to sync theme to auth connector`)}},getSnapshot(){return g(tt)}},rt=k(nt),it={eip155:void 0,solana:void 0,polkadot:void 0,bip122:void 0,cosmos:void 0},z=m({allConnectors:[],connectors:[],activeConnector:void 0,filterByNamespace:void 0,activeConnectorIds:{...it},filterByNamespaceMap:{eip155:!0,solana:!0,polkadot:!0,bip122:!0,cosmos:!0}}),B=k({state:z,subscribe(e){return h(z,()=>{e(z)})},subscribeKey(e,t){return v(z,e,t)},initialize(e){e.forEach(e=>{let t=T.getConnectedConnectorId(e);t&&B.setConnectorId(t,e)})},setActiveConnector(e){e&&(z.activeConnector=_(e))},setConnectors(e){e.filter(e=>!z.allConnectors.some(t=>t.id===e.id&&B.getConnectorName(t.name)===B.getConnectorName(e.name)&&t.chain===e.chain)).forEach(e=>{e.type!==`MULTI_CHAIN`&&z.allConnectors.push(_(e))});let t=B.getEnabledNamespaces(),n=B.getEnabledConnectors(t);z.connectors=B.mergeMultiChainConnectors(n)},filterByNamespaces(e){Object.keys(z.filterByNamespaceMap).forEach(e=>{z.filterByNamespaceMap[e]=!1}),e.forEach(e=>{z.filterByNamespaceMap[e]=!0}),B.updateConnectorsForEnabledNamespaces()},filterByNamespace(e,t){z.filterByNamespaceMap[e]=t,B.updateConnectorsForEnabledNamespaces()},updateConnectorsForEnabledNamespaces(){let e=B.getEnabledNamespaces(),t=B.getEnabledConnectors(e),n=B.areAllNamespacesEnabled();z.connectors=B.mergeMultiChainConnectors(t),n?I.clearFilterByNamespaces():I.filterByNamespaces(e)},getEnabledNamespaces(){return Object.entries(z.filterByNamespaceMap).filter(([e,t])=>t).map(([e])=>e)},getEnabledConnectors(e){return z.allConnectors.filter(t=>e.includes(t.chain))},areAllNamespacesEnabled(){return Object.values(z.filterByNamespaceMap).every(e=>e)},mergeMultiChainConnectors(e){let t=B.generateConnectorMapByName(e),n=[];return t.forEach(e=>{let t=e[0],r=t?.id===y.CONNECTOR_ID.AUTH;e.length>1&&t?n.push({name:t.name,imageUrl:t.imageUrl,imageId:t.imageId,connectors:[...e],type:r?`AUTH`:`MULTI_CHAIN`,chain:`eip155`,id:t?.id||``}):t&&n.push(t)}),n},generateConnectorMapByName(e){let t=new Map;return e.forEach(e=>{let{name:n}=e,r=B.getConnectorName(n);if(!r)return;let i=t.get(r)||[];i.find(t=>t.chain===e.chain)||i.push(e),t.set(r,i)}),t},getConnectorName(e){return e&&({"Trust Wallet":`Trust`}[e]||e)},getUniqueConnectorsByName(e){let t=[];return e.forEach(e=>{t.find(t=>t.chain===e.chain)||t.push(e)}),t},addConnector(e){if(e.id===y.CONNECTOR_ID.AUTH){let t=e,n=g(O.state),r=rt.getSnapshot().themeMode,i=rt.getSnapshot().themeVariables;t?.provider?.syncDappData?.({metadata:n.metadata,sdkVersion:n.sdkVersion,projectId:n.projectId,sdkType:n.sdkType}),t?.provider?.syncTheme({themeMode:r,themeVariables:i,w3mThemeVariables:Oe(i,r)}),B.setConnectors([e])}else B.setConnectors([e])},getAuthConnector(e){let t=e||J.state.activeChain,n=z.connectors.find(e=>e.id===y.CONNECTOR_ID.AUTH);if(n)return n?.connectors?.length?n.connectors.find(e=>e.chain===t):n},getAnnouncedConnectorRdns(){return z.connectors.filter(e=>e.type===`ANNOUNCED`).map(e=>e.info?.rdns)},getConnectorById(e){return z.allConnectors.find(t=>t.id===e)},getConnector(e,t){return z.allConnectors.filter(e=>e.chain===J.state.activeChain).find(n=>n.explorerId===e||n.info?.rdns===t)},syncIfAuthConnector(e){if(e.id!==`ID_AUTH`)return;let t=e,n=g(O.state),r=rt.getSnapshot().themeMode,i=rt.getSnapshot().themeVariables;t?.provider?.syncDappData?.({metadata:n.metadata,sdkVersion:n.sdkVersion,sdkType:n.sdkType,projectId:n.projectId}),t.provider.syncTheme({themeMode:r,themeVariables:i,w3mThemeVariables:Oe(i,r)})},getConnectorsByNamespace(e){let t=z.allConnectors.filter(t=>t.chain===e);return B.mergeMultiChainConnectors(t)},selectWalletConnector(e){let t=B.getConnector(e.id,e.rdns),n=J.state.activeChain;Ue.handleMobileDeeplinkRedirect(t?.explorerId||e.id,n),t?R.push(`ConnectingExternal`,{connector:t}):R.push(`ConnectingWalletConnect`,{wallet:e})},getConnectors(e){return e?B.getConnectorsByNamespace(e):B.mergeMultiChainConnectors(z.allConnectors)},setFilterByNamespace(e){z.filterByNamespace=e,z.connectors=B.getConnectors(e),I.setFilterByNamespace(e)},setConnectorId(e,t){e&&(z.activeConnectorIds={...z.activeConnectorIds,[t]:e},T.setConnectedConnectorId(t,e))},removeConnectorId(e){z.activeConnectorIds={...z.activeConnectorIds,[e]:void 0},T.deleteConnectedConnectorId(e)},getConnectorId(e){if(e)return z.activeConnectorIds[e]},isConnected(e){return e?!!z.activeConnectorIds[e]:Object.values(z.activeConnectorIds).some(e=>!!e)},resetConnectorIds(){z.activeConnectorIds={...it}}});e(),t!==void 0&&{}.NEXT_PUBLIC_SECURE_SITE_SDK_URL,t!==void 0&&{}.NEXT_PUBLIC_DEFAULT_LOG_LEVEL,t!==void 0&&{}.NEXT_PUBLIC_SECURE_SITE_SDK_VERSION;var at={SAFE_RPC_METHODS:`eth_accounts.eth_blockNumber.eth_call.eth_chainId.eth_estimateGas.eth_feeHistory.eth_gasPrice.eth_getAccount.eth_getBalance.eth_getBlockByHash.eth_getBlockByNumber.eth_getBlockReceipts.eth_getBlockTransactionCountByHash.eth_getBlockTransactionCountByNumber.eth_getCode.eth_getFilterChanges.eth_getFilterLogs.eth_getLogs.eth_getProof.eth_getStorageAt.eth_getTransactionByBlockHashAndIndex.eth_getTransactionByBlockNumberAndIndex.eth_getTransactionByHash.eth_getTransactionCount.eth_getTransactionReceipt.eth_getUncleCountByBlockHash.eth_getUncleCountByBlockNumber.eth_maxPriorityFeePerGas.eth_newBlockFilter.eth_newFilter.eth_newPendingTransactionFilter.eth_sendRawTransaction.eth_syncing.eth_uninstallFilter.wallet_getCapabilities.wallet_getCallsStatus.eth_getUserOperationReceipt.eth_estimateUserOperationGas.eth_getUserOperationByHash.eth_supportedEntryPoints.wallet_getAssets`.split(`.`),NOT_SAFE_RPC_METHODS:[`personal_sign`,`eth_signTypedData_v4`,`eth_sendTransaction`,`solana_signMessage`,`solana_signTransaction`,`solana_signAllTransactions`,`solana_signAndSendTransaction`,`wallet_sendCalls`,`wallet_grantPermissions`,`wallet_revokePermissions`,`eth_sendUserOperation`],GET_CHAIN_ID:`eth_chainId`,RPC_METHOD_NOT_ALLOWED_MESSAGE:`Requested RPC call is not allowed`,RPC_METHOD_NOT_ALLOWED_UI_MESSAGE:`Action not allowed`,ACCOUNT_TYPES:{EOA:`eoa`,SMART_ACCOUNT:`smartAccount`}},ot=Object.freeze({message:``,variant:`success`,svg:void 0,open:!1,autoClose:!0}),V=m({...ot}),st={state:V,subscribeKey(e,t){return v(V,e,t)},showLoading(e,t={}){this._showMessage({message:e,variant:`loading`,...t})},showSuccess(e){this._showMessage({message:e,variant:`success`})},showSvg(e,t){this._showMessage({message:e,svg:t})},showError(e){let t=E.parseError(e);this._showMessage({message:t,variant:`error`})},hide(){V.message=ot.message,V.variant=ot.variant,V.svg=ot.svg,V.open=ot.open,V.autoClose=ot.autoClose},_showMessage({message:e,svg:t,variant:n=`success`,autoClose:r=ot.autoClose}){V.open?(V.open=!1,setTimeout(()=>{V.message=e,V.variant=n,V.svg=t,V.open=!0,V.autoClose=r},150)):(V.message=e,V.variant=n,V.svg=t,V.open=!0,V.autoClose=r)}},H=m({transactions:[],coinbaseTransactions:{},transactionsByYear:{},lastNetworkInView:void 0,loading:!1,empty:!1,next:void 0}),ct=k({state:H,subscribe(e){return h(H,()=>e(H))},setLastNetworkInView(e){H.lastNetworkInView=e},async fetchTransactions(e,t){if(!e)throw Error(`Transactions can't be fetched without an accountAddress`);H.loading=!0;try{let n=await X.fetchTransactions({account:e,cursor:H.next,onramp:t,cache:t===`coinbase`?`no-cache`:void 0,chainId:J.state.activeCaipNetwork?.caipNetworkId}),r=ct.filterSpamTransactions(n.data),i=ct.filterByConnectedChain(r),a=[...H.transactions,...i];H.loading=!1,t===`coinbase`?H.coinbaseTransactions=ct.groupTransactionsByYearAndMonth(H.coinbaseTransactions,n.data):(H.transactions=a,H.transactionsByYear=ct.groupTransactionsByYearAndMonth(H.transactionsByYear,i)),H.empty=a.length===0,H.next=n.next?n.next:void 0}catch{let t=J.state.activeChain;N.sendEvent({type:`track`,event:`ERROR_FETCH_TRANSACTIONS`,properties:{address:e,projectId:O.state.projectId,cursor:H.next,isSmartAccount:Q.state.preferredAccountTypes?.[t]===at.ACCOUNT_TYPES.SMART_ACCOUNT}}),st.showError(`Failed to fetch transactions`),H.loading=!1,H.empty=!0,H.next=void 0}},groupTransactionsByYearAndMonth(e={},t=[]){let n=e;return t.forEach(e=>{let t=new Date(e.metadata.minedAt).getFullYear(),r=new Date(e.metadata.minedAt).getMonth(),i=n[t]??{},a=(i[r]??[]).filter(t=>t.id!==e.id);n[t]={...i,[r]:[...a,e].sort((e,t)=>new Date(t.metadata.minedAt).getTime()-new Date(e.metadata.minedAt).getTime())}}),n},filterSpamTransactions(e){return e.filter(e=>!e.transfers.every(e=>e.nft_info?.flags.is_spam===!0))},filterByConnectedChain(e){let t=J.state.activeCaipNetwork?.caipNetworkId;return e.filter(e=>e.metadata.chain===t)},clearCursor(){H.next=void 0},resetTransactions(){H.transactions=[],H.transactionsByYear={},H.lastNetworkInView=void 0,H.loading=!1,H.empty=!1,H.next=void 0}},`API_ERROR`),U=m({connections:new Map,wcError:!1,buffering:!1,status:`disconnected`}),lt,W=k({state:U,subscribeKey(e,t){return v(U,e,t)},_getClient(){return U._client},setClient(e){U._client=_(e)},async connectWalletConnect(){if(E.isTelegram()||E.isSafari()&&E.isIos()){if(lt){await lt,lt=void 0;return}if(!E.isPairingExpired(U?.wcPairingExpiry)){U.wcUri=U.wcUri;return}lt=W._getClient()?.connectWalletConnect?.().catch(()=>void 0),W.state.status=`connecting`,await lt,lt=void 0,U.wcPairingExpiry=void 0,W.state.status=`connected`}else await W._getClient()?.connectWalletConnect?.()},async connectExternal(e,t,n=!0){await W._getClient()?.connectExternal?.(e),n&&J.setActiveNamespace(t)},async reconnectExternal(e){await W._getClient()?.reconnectExternal?.(e);let t=e.chain||J.state.activeChain;t&&B.setConnectorId(e.id,t)},async setPreferredAccountType(e,t){yt.setLoading(!0,J.state.activeChain);let n=B.getAuthConnector();n&&(Q.setPreferredAccountType(e,t),await n.provider.setPreferredAccount(e),T.setPreferredAccountTypes(Q.state.preferredAccountTypes??{[t]:e}),await W.reconnectExternal(n),yt.setLoading(!1,J.state.activeChain),N.sendEvent({type:`track`,event:`SET_PREFERRED_ACCOUNT_TYPE`,properties:{accountType:e,network:J.state.activeCaipNetwork?.caipNetworkId||``}}))},async signMessage(e){return W._getClient()?.signMessage(e)},parseUnits(e,t){return W._getClient()?.parseUnits(e,t)},formatUnits(e,t){return W._getClient()?.formatUnits(e,t)},async sendTransaction(e){return W._getClient()?.sendTransaction(e)},async getCapabilities(e){return W._getClient()?.getCapabilities(e)},async grantPermissions(e){return W._getClient()?.grantPermissions(e)},async walletGetAssets(e){return W._getClient()?.walletGetAssets(e)??{}},async estimateGas(e){return W._getClient()?.estimateGas(e)},async writeContract(e){return W._getClient()?.writeContract(e)},async getEnsAddress(e){return W._getClient()?.getEnsAddress(e)},async getEnsAvatar(e){return W._getClient()?.getEnsAvatar(e)},checkInstalled(e){return W._getClient()?.checkInstalled?.(e)||!1},resetWcConnection(){U.wcUri=void 0,U.wcPairingExpiry=void 0,U.wcLinking=void 0,U.recentWallet=void 0,U.status=`disconnected`,ct.resetTransactions(),T.deleteWalletConnectDeepLink()},resetUri(){U.wcUri=void 0,U.wcPairingExpiry=void 0,lt=void 0},finalizeWcConnection(){let{wcLinking:e,recentWallet:t}=W.state;e&&T.setWalletConnectDeepLink(e),t&&T.setAppKitRecent(t),N.sendEvent({type:`track`,event:`CONNECT_SUCCESS`,properties:{method:e?`mobile`:`qrcode`,name:R.state.data?.wallet?.name||`Unknown`}})},setWcBasic(e){U.wcBasic=e},setUri(e){U.wcUri=e,U.wcPairingExpiry=E.getPairingExpiry()},setWcLinking(e){U.wcLinking=e},setWcError(e){U.wcError=e,U.buffering=!1},setRecentWallet(e){U.recentWallet=e},setBuffering(e){U.buffering=e},setStatus(e){U.status=e},async disconnect(e){try{await W._getClient()?.disconnect(e)}catch(e){throw new Ve(`Failed to disconnect`,`INTERNAL_SDK_ERROR`,e)}},setConnections(e,t){U.connections.set(t,e)},switchAccount({connection:e,address:t,namespace:n}){if(B.state.activeConnectorIds[n]===e.connectorId){let e=J.state.activeCaipNetwork;if(e){let r=`${n}:${e.id}:${t}`;Q.setCaipAddress(r,n)}else console.warn(`No current network found for namespace "${n}"`)}else{let t=B.getConnector(e.connectorId);t?W.connectExternal(t,n):console.warn(`No connector found for namespace "${n}"`)}}}),ut=m({loading:!1,open:!1,selectedNetworkId:void 0,activeChain:void 0,initialized:!1}),dt={state:ut,subscribe(e){return h(ut,()=>e(ut))},subscribeOpen(e){return v(ut,`open`,e)},set(e){Object.assign(ut,{...ut,...e})}},ft={createBalance(e,t){let n={name:e.metadata.name||``,symbol:e.metadata.symbol||``,decimals:e.metadata.decimals||0,value:e.metadata.value||0,price:e.metadata.price||0,iconUrl:e.metadata.iconUrl||``};return{name:n.name,symbol:n.symbol,chainId:t,address:e.address===`native`?void 0:this.convertAddressToCAIP10Address(e.address,t),value:n.value,price:n.price,quantity:{decimals:n.decimals.toString(),numeric:this.convertHexToBalance({hex:e.balance,decimals:n.decimals})},iconUrl:n.iconUrl}},convertHexToBalance({hex:e,decimals:t}){return n(BigInt(e),t)},convertAddressToCAIP10Address(e,t){return`${t}:${e}`},createCAIP2ChainId(e,t){return`${t}:${parseInt(e,16)}`},getChainIdHexFromCAIP2ChainId(e){let t=e.split(`:`);if(t.length<2||!t[1])return`0x0`;let n=t[1],r=parseInt(n,10);return isNaN(r)?`0x0`:`0x${r.toString(16)}`},isWalletGetAssetsResponse(e){return typeof e!=`object`||!e?!1:Object.values(e).every(e=>Array.isArray(e)&&e.every(e=>this.isValidAsset(e)))},isValidAsset(e){return typeof e==`object`&&!!e&&typeof e.address==`string`&&typeof e.balance==`string`&&(e.type===`ERC20`||e.type===`NATIVE`)&&typeof e.metadata==`object`&&e.metadata!==null&&typeof e.metadata.name==`string`&&typeof e.metadata.symbol==`string`&&typeof e.metadata.decimals==`number`&&typeof e.metadata.price==`number`&&typeof e.metadata.iconUrl==`string`}},pt={async getMyTokensWithBalance(e){let t=Q.state.address,n=J.state.activeCaipNetwork;if(!t||!n)return[];if(n.chainNamespace===`eip155`){let e=await this.getEIP155Balances(t,n);if(e)return this.filterLowQualityTokens(e)}let r=await X.getBalance(t,n.caipNetworkId,e);return this.filterLowQualityTokens(r.balances)},async getEIP155Balances(e,t){try{let n=ft.getChainIdHexFromCAIP2ChainId(t.caipNetworkId);if(!(await W.getCapabilities(e))?.[n]?.assetDiscovery?.supported)return null;let r=await W.walletGetAssets({account:e,chainFilter:[n]});return ft.isWalletGetAssetsResponse(r)?(r[n]||[]).map(e=>ft.createBalance(e,t.caipNetworkId)):null}catch{return null}},filterLowQualityTokens(e){return e.filter(e=>e.quantity.decimals!==`0`)},mapBalancesToSwapTokens(e){return e?.map(e=>({...e,address:e?.address?e.address:J.getActiveNetworkTokenAddress(),decimals:parseInt(e.quantity.decimals,10),logoUri:e.iconUrl,eip2612:!1}))||[]}},G=m({tokenBalances:[],loading:!1}),K=k({state:G,subscribe(e){return h(G,()=>e(G))},subscribeKey(e,t){return v(G,e,t)},setToken(e){e&&(G.token=_(e))},setTokenAmount(e){G.sendTokenAmount=e},setReceiverAddress(e){G.receiverAddress=e},setReceiverProfileImageUrl(e){G.receiverProfileImageUrl=e},setReceiverProfileName(e){G.receiverProfileName=e},setNetworkBalanceInUsd(e){G.networkBalanceInUSD=e},setLoading(e){G.loading=e},async sendToken(){try{switch(K.setLoading(!0),J.state.activeCaipNetwork?.chainNamespace){case`eip155`:await K.sendEvmToken();return;case`solana`:await K.sendSolanaToken();return;default:throw Error(`Unsupported chain`)}}finally{K.setLoading(!1)}},async sendEvmToken(){let e=J.state.activeChain,t=Q.state.preferredAccountTypes?.[e];if(!K.state.sendTokenAmount||!K.state.receiverAddress)throw Error(`An amount and receiver address are required`);if(!K.state.token)throw Error(`A token is required`);K.state.token?.address?(N.sendEvent({type:`track`,event:`SEND_INITIATED`,properties:{isSmartAccount:t===at.ACCOUNT_TYPES.SMART_ACCOUNT,token:K.state.token.address,amount:K.state.sendTokenAmount,network:J.state.activeCaipNetwork?.caipNetworkId||``}}),await K.sendERC20Token({receiverAddress:K.state.receiverAddress,tokenAddress:K.state.token.address,sendTokenAmount:K.state.sendTokenAmount,decimals:K.state.token.quantity.decimals})):(N.sendEvent({type:`track`,event:`SEND_INITIATED`,properties:{isSmartAccount:t===at.ACCOUNT_TYPES.SMART_ACCOUNT,token:K.state.token.symbol||``,amount:K.state.sendTokenAmount,network:J.state.activeCaipNetwork?.caipNetworkId||``}}),await K.sendNativeToken({receiverAddress:K.state.receiverAddress,sendTokenAmount:K.state.sendTokenAmount,decimals:K.state.token.quantity.decimals}))},async fetchTokenBalance(e){G.loading=!0;let t=J.state.activeCaipNetwork?.caipNetworkId,n=J.state.activeCaipNetwork?.chainNamespace,r=J.state.activeCaipAddress,i=r?E.getPlainAddress(r):void 0;if(G.lastRetry&&!E.isAllowedRetry(G.lastRetry,30*w.ONE_SEC_MS))return G.loading=!1,[];try{if(i&&t&&n){let e=await pt.getMyTokensWithBalance();return G.tokenBalances=e,G.lastRetry=void 0,e}}catch(t){G.lastRetry=Date.now(),e?.(t),st.showError(`Token Balance Unavailable`)}finally{G.loading=!1}return[]},fetchNetworkBalance(){if(G.tokenBalances.length===0)return;let e=pt.mapBalancesToSwapTokens(G.tokenBalances);if(!e)return;let t=e.find(e=>e.address===J.getActiveNetworkTokenAddress());t&&(G.networkBalanceInUSD=t?xe.multiply(t.quantity.numeric,t.price).toString():`0`)},async sendNativeToken(e){R.pushTransactionStack({});let t=e.receiverAddress,n=Q.state.address,r=W.parseUnits(e.sendTokenAmount.toString(),Number(e.decimals));await W.sendTransaction({chainNamespace:`eip155`,to:t,address:n,data:`0x`,value:r??BigInt(0)}),N.sendEvent({type:`track`,event:`SEND_SUCCESS`,properties:{isSmartAccount:Q.state.preferredAccountTypes?.eip155===at.ACCOUNT_TYPES.SMART_ACCOUNT,token:K.state.token?.symbol||``,amount:e.sendTokenAmount,network:J.state.activeCaipNetwork?.caipNetworkId||``}}),W._getClient()?.updateBalance(`eip155`),K.resetSend()},async sendERC20Token(e){R.pushTransactionStack({onSuccess(){R.replace(`Account`)}});let t=W.parseUnits(e.sendTokenAmount.toString(),Number(e.decimals));if(Q.state.address&&e.sendTokenAmount&&e.receiverAddress&&e.tokenAddress){let n=E.getPlainAddress(e.tokenAddress);await W.writeContract({fromAddress:Q.state.address,tokenAddress:n,args:[e.receiverAddress,t??BigInt(0)],method:`transfer`,abi:Te.getERC20Abi(n),chainNamespace:`eip155`}),K.resetSend()}},async sendSolanaToken(){if(!K.state.sendTokenAmount||!K.state.receiverAddress)throw Error(`An amount and receiver address are required`);R.pushTransactionStack({onSuccess(){R.replace(`Account`)}}),await W.sendTransaction({chainNamespace:`solana`,to:K.state.receiverAddress,value:K.state.sendTokenAmount}),W._getClient()?.updateBalance(`solana`),K.resetSend()},resetSend(){G.token=void 0,G.sendTokenAmount=void 0,G.receiverAddress=void 0,G.receiverProfileImageUrl=void 0,G.receiverProfileName=void 0,G.loading=!1,G.tokenBalances=[]}}),mt={currentTab:0,tokenBalance:[],smartAccountDeployed:!1,addressLabels:new Map,allAccounts:[],user:void 0},ht={caipNetwork:void 0,supportsAllNetworks:!0,smartAccountEnabledNetworks:[]},q=m({chains:te(),activeCaipAddress:void 0,activeChain:void 0,activeCaipNetwork:void 0,noAdapters:!1,universalAdapter:{networkControllerClient:void 0,connectionControllerClient:void 0},isSwitchingNamespace:!1}),J=k({state:q,subscribe(e){return h(q,()=>{e(q)})},subscribeKey(e,t){return v(q,e,t)},subscribeChainProp(e,t,n){let r;return h(q.chains,()=>{let i=n||q.activeChain;if(i){let n=q.chains.get(i)?.[e];r!==n&&(r=n,t(n))}})},initialize(e,t,n){let{chainId:r,namespace:i}=T.getActiveNetworkProps(),a=t?.find(e=>e.id.toString()===r?.toString()),o=e.find(e=>e?.namespace===i)||e?.[0],s=e.map(e=>e.namespace).filter(e=>e!==void 0),c=O.state.enableEmbedded?new Set([...s]):new Set([...t?.map(e=>e.chainNamespace)??[]]);(e?.length===0||!o)&&(q.noAdapters=!0),q.noAdapters||(q.activeChain=o?.namespace,q.activeCaipNetwork=a,J.setChainNetworkData(o?.namespace,{caipNetwork:a}),q.activeChain&&dt.set({activeChain:o?.namespace})),c.forEach(e=>{let r=t?.filter(t=>t.chainNamespace===e);J.state.chains.set(e,{namespace:e,networkState:m({...ht,caipNetwork:r?.[0]}),accountState:m(mt),caipNetworks:r??[],...n}),J.setRequestedCaipNetworks(r??[],e)})},removeAdapter(e){if(q.activeChain===e){let t=Array.from(q.chains.entries()).find(([t])=>t!==e);if(t){let e=t[1]?.caipNetworks?.[0];e&&J.setActiveCaipNetwork(e)}}q.chains.delete(e)},addAdapter(e,{networkControllerClient:t,connectionControllerClient:n},r){q.chains.set(e.namespace,{namespace:e.namespace,networkState:{...ht,caipNetwork:r[0]},accountState:mt,caipNetworks:r,connectionControllerClient:n,networkControllerClient:t}),J.setRequestedCaipNetworks(r?.filter(t=>t.chainNamespace===e.namespace)??[],e.namespace)},addNetwork(e){let t=q.chains.get(e.chainNamespace);if(t){let n=[...t.caipNetworks||[]];t.caipNetworks?.find(t=>t.id===e.id)||n.push(e),q.chains.set(e.chainNamespace,{...t,caipNetworks:n}),J.setRequestedCaipNetworks(n,e.chainNamespace),B.filterByNamespace(e.chainNamespace,!0)}},removeNetwork(e,t){let n=q.chains.get(e);if(n){let r=q.activeCaipNetwork?.id===t,i=[...n.caipNetworks?.filter(e=>e.id!==t)||[]];r&&n?.caipNetworks?.[0]&&J.setActiveCaipNetwork(n.caipNetworks[0]),q.chains.set(e,{...n,caipNetworks:i}),J.setRequestedCaipNetworks(i||[],e),i.length===0&&B.filterByNamespace(e,!1)}},setAdapterNetworkState(e,t){let n=q.chains.get(e);n&&(n.networkState={...n.networkState||ht,...t},q.chains.set(e,n))},setChainAccountData(e,t,n=!0){if(!e)throw Error(`Chain is required to update chain account data`);let r=q.chains.get(e);if(r){let n={...r.accountState||mt,...t};q.chains.set(e,{...r,accountState:n}),(q.chains.size===1||q.activeChain===e)&&(t.caipAddress&&(q.activeCaipAddress=t.caipAddress),Q.replaceState(n))}},setChainNetworkData(e,t){if(!e)return;let n=q.chains.get(e);if(n){let r={...n.networkState||ht,...t};q.chains.set(e,{...n,networkState:r})}},setAccountProp(e,t,n,r=!0){J.setChainAccountData(n,{[e]:t},r),e===`status`&&t===`disconnected`&&n&&B.removeConnectorId(n)},setActiveNamespace(e){q.activeChain=e;let t=e?q.chains.get(e):void 0,n=t?.networkState?.caipNetwork;n?.id&&e&&(q.activeCaipAddress=t?.accountState?.caipAddress,q.activeCaipNetwork=n,J.setChainNetworkData(e,{caipNetwork:n}),T.setActiveCaipNetworkId(n?.caipNetworkId),dt.set({activeChain:e,selectedNetworkId:n?.caipNetworkId}))},setActiveCaipNetwork(e){if(!e)return;q.activeChain!==e.chainNamespace&&J.setIsSwitchingNamespace(!0);let t=q.chains.get(e.chainNamespace);q.activeChain=e.chainNamespace,q.activeCaipNetwork=e,J.setChainNetworkData(e.chainNamespace,{caipNetwork:e}),q.activeCaipAddress=t?.accountState?.address?`${e.chainNamespace}:${e.id}:${t?.accountState?.address}`:void 0,J.setAccountProp(`caipAddress`,q.activeCaipAddress,e.chainNamespace),t&&Q.replaceState(t.accountState),K.resetSend(),dt.set({activeChain:q.activeChain,selectedNetworkId:q.activeCaipNetwork?.caipNetworkId}),T.setActiveCaipNetworkId(e.caipNetworkId),!J.checkIfSupportedNetwork(e.chainNamespace)&&O.state.enableNetworkSwitch&&!O.state.allowUnsupportedChain&&!W.state.wcBasic&&J.showUnsupportedChainUI()},addCaipNetwork(e){if(!e)return;let t=q.chains.get(e.chainNamespace);t&&t?.caipNetworks?.push(e)},async switchActiveNamespace(e){if(!e)return;let t=e!==J.state.activeChain,n=J.getNetworkData(e)?.caipNetwork,r=J.getCaipNetworkByNamespace(e,n?.id);t&&r&&await J.switchActiveNetwork(r)},async switchActiveNetwork(e){let t=!J.state.chains.get(J.state.activeChain)?.caipNetworks?.some(e=>e.id===q.activeCaipNetwork?.id),n=J.getNetworkControllerClient(e.chainNamespace);if(n){try{await n.switchCaipNetwork(e),t&&yt.close()}catch{R.goBack()}N.sendEvent({type:`track`,event:`SWITCH_NETWORK`,properties:{network:e.caipNetworkId}})}},getNetworkControllerClient(e){let t=e||q.activeChain,n=q.chains.get(t);if(!n)throw Error(`Chain adapter not found`);if(!n.networkControllerClient)throw Error(`NetworkController client not set`);return n.networkControllerClient},getConnectionControllerClient(e){let t=e||q.activeChain;if(!t)throw Error(`Chain is required to get connection controller client`);let n=q.chains.get(t);if(!n?.connectionControllerClient)throw Error(`ConnectionController client not set`);return n.connectionControllerClient},getAccountProp(e,t){let n=q.activeChain;if(t&&(n=t),!n)return;let r=q.chains.get(n)?.accountState;if(r)return r[e]},getNetworkProp(e,t){let n=q.chains.get(t)?.networkState;if(n)return n[e]},getRequestedCaipNetworks(e){let{approvedCaipNetworkIds:t=[],requestedCaipNetworks:n=[]}=q.chains.get(e)?.networkState||{};return E.sortRequestedNetworks(t,n)},getAllRequestedCaipNetworks(){let e=[];return q.chains.forEach(t=>{let n=J.getRequestedCaipNetworks(t.namespace);e.push(...n)}),e},setRequestedCaipNetworks(e,t){J.setAdapterNetworkState(t,{requestedCaipNetworks:e});let n=J.getAllRequestedCaipNetworks().map(e=>e.chainNamespace),r=Array.from(new Set(n));B.filterByNamespaces(r)},getAllApprovedCaipNetworkIds(){let e=[];return q.chains.forEach(t=>{let n=J.getApprovedCaipNetworkIds(t.namespace);e.push(...n)}),e},getActiveCaipNetwork(){return q.activeCaipNetwork},getActiveCaipAddress(){return q.activeCaipAddress},getApprovedCaipNetworkIds(e){return q.chains.get(e)?.networkState?.approvedCaipNetworkIds||[]},async setApprovedCaipNetworksData(e){let t=await J.getNetworkControllerClient()?.getApprovedCaipNetworksData();J.setAdapterNetworkState(e,{approvedCaipNetworkIds:t?.approvedCaipNetworkIds,supportsAllNetworks:t?.supportsAllNetworks})},checkIfSupportedNetwork(e,t){let n=t||q.activeCaipNetwork,r=J.getRequestedCaipNetworks(e);return!r.length||r?.some(e=>e.id===n?.id)},checkIfSupportedChainId(e){return!q.activeChain||J.getRequestedCaipNetworks(q.activeChain)?.some(t=>t.id===e)},setSmartAccountEnabledNetworks(e,t){J.setAdapterNetworkState(t,{smartAccountEnabledNetworks:e})},checkIfSmartAccountEnabled(){let e=ne.caipNetworkIdToNumber(q.activeCaipNetwork?.caipNetworkId),t=q.activeChain;return!t||!e?!1:!!J.getNetworkProp(`smartAccountEnabledNetworks`,t)?.includes(Number(e))},getActiveNetworkTokenAddress(){let e=q.activeCaipNetwork?.chainNamespace||`eip155`;return`${e}:${q.activeCaipNetwork?.id||1}:${w.NATIVE_TOKEN_ADDRESS[e]}`},showUnsupportedChainUI(){yt.open({view:`UnsupportedChain`})},checkIfNamesSupported(){let e=q.activeCaipNetwork;return!!(e?.chainNamespace&&w.NAMES_SUPPORTED_CHAIN_NAMESPACES.includes(e.chainNamespace))},resetNetwork(e){J.setAdapterNetworkState(e,{approvedCaipNetworkIds:void 0,supportsAllNetworks:!0,smartAccountEnabledNetworks:[]})},resetAccount(e){let t=e;if(!t)throw Error(`Chain is required to set account prop`);q.activeCaipAddress=void 0,J.setChainAccountData(t,{smartAccountDeployed:!1,currentTab:0,caipAddress:void 0,address:void 0,balance:void 0,balanceSymbol:void 0,profileName:void 0,profileImage:void 0,addressExplorerUrl:void 0,tokenBalance:[],connectedWalletInfo:void 0,preferredAccountTypes:void 0,socialProvider:void 0,socialWindow:void 0,farcasterUrl:void 0,allAccounts:[],user:void 0,status:`disconnected`}),B.removeConnectorId(t)},setIsSwitchingNamespace(e){q.isSwitchingNamespace=e},getFirstCaipNetworkSupportsAuthConnector(){let e=[],t;if(q.chains.forEach(t=>{y.AUTH_CONNECTOR_SUPPORTED_CHAINS.find(e=>e===t.namespace)&&t.namespace&&e.push(t.namespace)}),e.length>0){let n=e[0];return t=n?q.chains.get(n)?.caipNetworks?.[0]:void 0,t}},getAccountData(e){return e?J.state.chains.get(e)?.accountState:Q.state},getNetworkData(e){let t=e||q.activeChain;if(t)return J.state.chains.get(t)?.networkState},getCaipNetworkByNamespace(e,t){if(!e)return;let n=J.state.chains.get(e);return n?.caipNetworks?.find(e=>e.id===t)||n?.networkState?.caipNetwork||n?.caipNetworks?.[0]},getRequestedCaipNetworkIds(){let e=B.state.filterByNamespace;return(e?[q.chains.get(e)]:Array.from(q.chains.values())).flatMap(e=>e?.caipNetworks||[]).map(e=>e.caipNetworkId)},getCaipNetworks(e){return e?J.getRequestedCaipNetworks(e):J.getAllRequestedCaipNetworks()}}),gt={purchaseCurrencies:[{id:`2b92315d-eab7-5bef-84fa-089a131333f5`,name:`USD Coin`,symbol:`USDC`,networks:[{name:`ethereum-mainnet`,display_name:`Ethereum`,chain_id:`1`,contract_address:`0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48`},{name:`polygon-mainnet`,display_name:`Polygon`,chain_id:`137`,contract_address:`0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174`}]},{id:`2b92315d-eab7-5bef-84fa-089a131333f5`,name:`Ether`,symbol:`ETH`,networks:[{name:`ethereum-mainnet`,display_name:`Ethereum`,chain_id:`1`,contract_address:`0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48`},{name:`polygon-mainnet`,display_name:`Polygon`,chain_id:`137`,contract_address:`0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174`}]}],paymentCurrencies:[{id:`USD`,payment_method_limits:[{id:`card`,min:`10.00`,max:`7500.00`},{id:`ach_bank_account`,min:`10.00`,max:`25000.00`}]},{id:`EUR`,payment_method_limits:[{id:`card`,min:`10.00`,max:`7500.00`},{id:`ach_bank_account`,min:`10.00`,max:`25000.00`}]}]},_t=E.getBlockchainApiUrl(),Y=m({clientId:null,api:new Ne({baseUrl:_t,clientId:null}),supportedChains:{http:[],ws:[]}}),X={state:Y,async get(e){let{st:t,sv:n}=X.getSdkProperties(),r=O.state.projectId,i={...e.params||{},st:t,sv:n,projectId:r};return Y.api.get({...e,params:i})},getSdkProperties(){let{sdkType:e,sdkVersion:t}=O.state;return{st:e||`unknown`,sv:t||`unknown`}},async isNetworkSupported(e){if(!e)return!1;try{Y.supportedChains.http.length||await X.getSupportedNetworks()}catch{return!1}return Y.supportedChains.http.includes(e)},async getSupportedNetworks(){try{let e=await X.get({path:`v1/supported-chains`});return Y.supportedChains=e,e}catch{return Y.supportedChains}},async fetchIdentity({address:e,caipNetworkId:t}){if(!await X.isNetworkSupported(t))return{avatar:``,name:``};let n=T.getIdentityFromCacheForAddress(e);if(n)return n;let r=await X.get({path:`/v1/identity/${e}`,params:{sender:J.state.activeCaipAddress?E.getPlainAddress(J.state.activeCaipAddress):void 0}});return T.updateIdentityCache({address:e,identity:r,timestamp:Date.now()}),r},async fetchTransactions({account:e,cursor:t,onramp:n,signal:r,cache:i,chainId:a}){return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?X.get({path:`/v1/account/${e}/history`,params:{cursor:t,onramp:n,chainId:a},signal:r,cache:i}):{data:[],next:void 0}},async fetchSwapQuote({amount:e,userAddress:t,from:n,to:r,gasPrice:i}){return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?X.get({path:`/v1/convert/quotes`,headers:{"Content-Type":`application/json`},params:{amount:e,userAddress:t,from:n,to:r,gasPrice:i}}):{quotes:[]}},async fetchSwapTokens({chainId:e}){return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?X.get({path:`/v1/convert/tokens`,params:{chainId:e}}):{tokens:[]}},async fetchTokenPrice({addresses:e}){return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?Y.api.post({path:`/v1/fungible/price`,body:{currency:`usd`,addresses:e,projectId:O.state.projectId},headers:{"Content-Type":`application/json`}}):{fungibles:[]}},async fetchSwapAllowance({tokenAddress:e,userAddress:t}){return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?X.get({path:`/v1/convert/allowance`,params:{tokenAddress:e,userAddress:t},headers:{"Content-Type":`application/json`}}):{allowance:`0`}},async fetchGasPrice({chainId:e}){let{st:t,sv:n}=X.getSdkProperties();if(!await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId))throw Error(`Network not supported for Gas Price`);return X.get({path:`/v1/convert/gas-price`,headers:{"Content-Type":`application/json`},params:{chainId:e,st:t,sv:n}})},async generateSwapCalldata({amount:e,from:t,to:n,userAddress:r,disableEstimate:i}){if(!await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId))throw Error(`Network not supported for Swaps`);return Y.api.post({path:`/v1/convert/build-transaction`,headers:{"Content-Type":`application/json`},body:{amount:e,eip155:{slippage:w.CONVERT_SLIPPAGE_TOLERANCE},projectId:O.state.projectId,from:t,to:n,userAddress:r,disableEstimate:i}})},async generateApproveCalldata({from:e,to:t,userAddress:n}){let{st:r,sv:i}=X.getSdkProperties();if(!await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId))throw Error(`Network not supported for Swaps`);return X.get({path:`/v1/convert/build-approve`,headers:{"Content-Type":`application/json`},params:{userAddress:n,from:e,to:t,st:r,sv:i}})},async getBalance(e,t,n){let{st:r,sv:i}=X.getSdkProperties();if(!await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId))return st.showError(`Token Balance Unavailable`),{balances:[]};let a=`${t}:${e}`,o=T.getBalanceCacheForCaipAddress(a);if(o)return o;let s=await X.get({path:`/v1/account/${e}/balance`,params:{currency:`usd`,chainId:t,forceUpdate:n,st:r,sv:i}});return T.updateBalanceCache({caipAddress:a,balance:s,timestamp:Date.now()}),s},async lookupEnsName(e){return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?X.get({path:`/v1/profile/account/${e}`,params:{apiVersion:`2`}}):{addresses:{},attributes:[]}},async reverseLookupEnsName({address:e}){return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?X.get({path:`/v1/profile/reverse/${e}`,params:{sender:Q.state.address,apiVersion:`2`}}):[]},async getEnsNameSuggestions(e){return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?X.get({path:`/v1/profile/suggestions/${e}`,params:{zone:`reown.id`}}):{suggestions:[]}},async registerEnsName({coinType:e,address:t,message:n,signature:r}){return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?Y.api.post({path:`/v1/profile/account`,body:{coin_type:e,address:t,message:n,signature:r},headers:{"Content-Type":`application/json`}}):{success:!1}},async generateOnRampURL({destinationWallets:e,partnerUserId:t,defaultNetwork:n,purchaseAmount:r,paymentAmount:i}){return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?(await Y.api.post({path:`/v1/generators/onrampurl`,params:{projectId:O.state.projectId},body:{destinationWallets:e,defaultNetwork:n,partnerUserId:t,defaultExperience:`buy`,presetCryptoAmount:r,presetFiatAmount:i}})).url:``},async getOnrampOptions(){if(!await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId))return{paymentCurrencies:[],purchaseCurrencies:[]};try{return await X.get({path:`/v1/onramp/options`})}catch{return gt}},async getOnrampQuote({purchaseCurrency:e,paymentCurrency:t,amount:n,network:r}){try{return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?await Y.api.post({path:`/v1/onramp/quote`,params:{projectId:O.state.projectId},body:{purchaseCurrency:e,paymentCurrency:t,amount:n,network:r}}):null}catch{return{coinbaseFee:{amount:n,currency:t.id},networkFee:{amount:n,currency:t.id},paymentSubtotal:{amount:n,currency:t.id},paymentTotal:{amount:n,currency:t.id},purchaseAmount:{amount:n,currency:t.id},quoteId:`mocked-quote-id`}}},async getSmartSessions(e){return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?X.get({path:`/v1/sessions/${e}`}):[]},async revokeSmartSession(e,t,n){return await X.isNetworkSupported(J.state.activeCaipNetwork?.caipNetworkId)?Y.api.post({path:`/v1/sessions/${e}/revoke`,params:{projectId:O.state.projectId},body:{pci:t,signature:n}}):{success:!1}},setClientId(e){Y.clientId=e,Y.api=new Ne({baseUrl:_t,clientId:e})}},Z=m({currentTab:0,tokenBalance:[],smartAccountDeployed:!1,addressLabels:new Map,allAccounts:[]}),Q=k({state:Z,replaceState(e){e&&Object.assign(Z,_(e))},subscribe(e){return J.subscribeChainProp(`accountState`,t=>{if(t)return e(t)})},subscribeKey(e,t,n){let r;return J.subscribeChainProp(`accountState`,n=>{if(n){let i=n[e];r!==i&&(r=i,t(i))}},n)},setStatus(e,t){J.setAccountProp(`status`,e,t)},getCaipAddress(e){return J.getAccountProp(`caipAddress`,e)},setCaipAddress(e,t){let n=e?E.getPlainAddress(e):void 0;t===J.state.activeChain&&(J.state.activeCaipAddress=e),J.setAccountProp(`caipAddress`,e,t),J.setAccountProp(`address`,n,t)},setBalance(e,t,n){J.setAccountProp(`balance`,e,n),J.setAccountProp(`balanceSymbol`,t,n)},setProfileName(e,t){J.setAccountProp(`profileName`,e,t)},setProfileImage(e,t){J.setAccountProp(`profileImage`,e,t)},setUser(e,t){J.setAccountProp(`user`,e,t)},setAddressExplorerUrl(e,t){J.setAccountProp(`addressExplorerUrl`,e,t)},setSmartAccountDeployed(e,t){J.setAccountProp(`smartAccountDeployed`,e,t)},setCurrentTab(e){J.setAccountProp(`currentTab`,e,J.state.activeChain)},setTokenBalance(e,t){e&&J.setAccountProp(`tokenBalance`,e,t)},setShouldUpdateToAddress(e,t){J.setAccountProp(`shouldUpdateToAddress`,e,t)},setAllAccounts(e,t){J.setAccountProp(`allAccounts`,e,t)},addAddressLabel(e,t,n){let r=J.getAccountProp(`addressLabels`,n)||new Map;r.set(e,t),J.setAccountProp(`addressLabels`,r,n)},removeAddressLabel(e,t){let n=J.getAccountProp(`addressLabels`,t)||new Map;n.delete(e),J.setAccountProp(`addressLabels`,n,t)},setConnectedWalletInfo(e,t){J.setAccountProp(`connectedWalletInfo`,e,t,!1)},setPreferredAccountType(e,t){J.setAccountProp(`preferredAccountTypes`,{...Z.preferredAccountTypes,[t]:e},t)},setPreferredAccountTypes(e){Z.preferredAccountTypes=e},setSocialProvider(e,t){e&&J.setAccountProp(`socialProvider`,e,t)},setSocialWindow(e,t){J.setAccountProp(`socialWindow`,e?_(e):void 0,t)},setFarcasterUrl(e,t){J.setAccountProp(`farcasterUrl`,e,t)},async fetchTokenBalance(e){Z.balanceLoading=!0;let t=J.state.activeCaipNetwork?.caipNetworkId,n=J.state.activeCaipNetwork?.chainNamespace,r=J.state.activeCaipAddress,i=r?E.getPlainAddress(r):void 0;if(Z.lastRetry&&!E.isAllowedRetry(Z.lastRetry,30*w.ONE_SEC_MS))return Z.balanceLoading=!1,[];try{if(i&&t&&n){let e=(await X.getBalance(i,t)).balances.filter(e=>e.quantity.decimals!==`0`);return Q.setTokenBalance(e,n),Z.lastRetry=void 0,Z.balanceLoading=!1,e}}catch(t){Z.lastRetry=Date.now(),e?.(t),st.showError(`Token Balance Unavailable`)}finally{Z.balanceLoading=!1}return[]},resetAccount(e){J.resetAccount(e)}}),vt={onSwitchNetwork({network:e,ignoreSwitchConfirmation:t=!1}){let n=J.state.activeCaipNetwork,r=R.state.data;if(e.id===n?.id)return;let i=Q.getCaipAddress(J.state.activeChain),a=e.chainNamespace!==J.state.activeChain,o=Q.getCaipAddress(e.chainNamespace),s=B.getConnectorId(J.state.activeChain)===y.CONNECTOR_ID.AUTH,c=y.AUTH_CONNECTOR_SUPPORTED_CHAINS.find(t=>t===e.chainNamespace);t||s&&c?R.push(`SwitchNetwork`,{...r,network:e}):i&&a&&!o?R.push(`SwitchActiveChain`,{switchToChain:e.chainNamespace,navigateTo:`Connect`,navigateWithReplace:!0,network:e}):R.push(`SwitchNetwork`,{...r,network:e})}},$=m({loading:!1,loadingNamespaceMap:new Map,open:!1,shake:!1,namespace:void 0}),yt=k({state:$,subscribe(e){return h($,()=>e($))},subscribeKey(e,t){return v($,e,t)},async open(e){let t=Q.state.status===`connected`,n=e?.namespace,r=J.state.activeChain,i=n&&n!==r,a=J.getAccountData(e?.namespace)?.caipAddress;if(W.state.wcBasic?I.prefetch({fetchNetworkImages:!1,fetchConnectorImages:!1}):await I.prefetch({fetchConnectorImages:!t,fetchFeaturedWallets:!t,fetchRecommendedWallets:!t}),B.setFilterByNamespace(e?.namespace),yt.setLoading(!0,n),n&&i){let e=J.getNetworkData(n)?.caipNetwork||J.getRequestedCaipNetworks(n)[0];e&&vt.onSwitchNetwork({network:e,ignoreSwitchConfirmation:!0})}else{let t=J.state.noAdapters;O.state.manualWCControl||t&&!a?E.isMobile()?R.reset(`AllWallets`):R.reset(`ConnectingWalletConnectBasic`):e?.view?R.reset(e.view,e.data):a?R.reset(`Account`):R.reset(`Connect`)}$.open=!0,dt.set({open:!0}),N.sendEvent({type:`track`,event:`MODAL_OPEN`,properties:{connected:!!a}})},close(){let e=O.state.enableEmbedded,t=!!J.state.activeCaipAddress;$.open&&N.sendEvent({type:`track`,event:`MODAL_CLOSE`,properties:{connected:t}}),$.open=!1,R.reset(`Connect`),yt.clearLoading(),e?t?R.replace(`Account`):R.push(`Connect`):dt.set({open:!1}),W.resetUri()},setLoading(e,t){t&&$.loadingNamespaceMap.set(t,e),$.loading=e,dt.set({loading:e})},clearLoading(){$.loadingNamespaceMap.clear(),$.loading=!1},shake(){$.shake||($.shake=!0,setTimeout(()=>{$.shake=!1},500))}}),bt=void 0,xt=void 0,St=void 0;function Ct(e,t){bt=document.createElement(`style`),xt=document.createElement(`style`),St=document.createElement(`style`),bt.textContent=Et(e).core.cssText,xt.textContent=Et(e).dark.cssText,St.textContent=Et(e).light.cssText,document.head.appendChild(bt),document.head.appendChild(xt),document.head.appendChild(St),wt(t)}function wt(e){xt&&St&&(e===`light`?(xt.removeAttribute(`media`),St.media=`enabled`):(St.removeAttribute(`media`),xt.media=`enabled`))}function Tt(e){bt&&xt&&St&&(bt.textContent=Et(e).core.cssText,xt.textContent=Et(e).dark.cssText,St.textContent=Et(e).light.cssText)}function Et(e){return{core:r`
    ...
    `,light:r`
      :root {
        ...
        --w3m-accent: ${i(Oe(e,`dark`)[`--w3m-accent`])};
        --w3m-default: #fff;

        --wui-color-modal-bg-base: ${i(Oe(e,`dark`)[`--w3m-background`])};
    ...
    `,dark:r`
      :root {
        ...
        --w3m-accent: ${i(Oe(e,`light`)[`--w3m-accent`])};
        --w3m-default: #000;

        --wui-color-modal-bg-base: ${i(Oe(e,`light`)[`--w3m-background`])};
        --wui-color-accent-base-100: var(--w3m-accent);
...
`;e();var At={ACCOUNT_TABS:[{label:`Tokens`},{label:`NFTs`},{label:`Activity`}],SECURE_SITE_ORIGIN:(t===void 0?void 0:{}.NEXT_PUBLIC_SECURE_SITE_ORIGIN)||`https://secure.walletconnect.org`,VIEW_DIRECTION:{Next:`next`,Prev:`prev`},DEFAULT_CONNECT_METHOD_ORDER:[`email`,`social`,`wallet`],ANIMATION_DURATIONS:{HeaderText:120,ModalHeight:150,ViewTransition:150}};export{je as A,Ke as C,E as D,O as E,m as F,_ as I,h as L,ne as M,y as N,T as O,v as P,Je as S,k as T,B as _,Dt as a,I as b,yt as c,J as d,K as f,at as g,st as h,Ct as i,Ae as j,w as k,Q as l,W as m,kt as n,wt as o,dt as p,Ot as r,Tt as s,At as t,X as u,rt as v,M as w,N as x,R as y};